...
import aiida_porousmaterials  # pylint: disable=wrong-import-position
VERSION = aiida_porousmaterials.__version__

if VERSION != SETUP_CONTENT['version']:
    print('version number mismatch detected:')
    print("version number in '{}': {}".format(SETUP_FNAME, SETUP_CONTENT['version']))
    print("version number in '{}/__init__.py': {}".format('aiida_porousmaterials', VERSION))
    sys.exit(1)
